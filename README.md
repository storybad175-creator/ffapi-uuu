...
```bash
# Single UID
python -m cli --uid 4899748638 --region IND

# Batch Mode
python -m cli --batch uids.txt --region BR

# Compact Output
python -m cli --uid 4899748638 --region IND --format compact
```
